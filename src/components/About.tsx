        ...
        <div className="space-y-12">
          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            ...
            <div className="bg-light-blue p-6 rounded-lg border-l-4 border-red-accent py-0">
              ...
              <p className="text-medium-gray text-sm mt-2 text-right font-normal">El trabajo con la psicoterapia Gestalt Integrativa se centra en el restablecimiento de tu equilibrio emocional y relacional con el objetivo de que puedas conseguir una vida más plena, mediante:</p>
            </div>
          </div>
        </div>
      </div>
